  ...
  <Dialog v-model:open="dialogOpen">
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          <p v-if="!itemToDelete">
            Are you sure you want to delete {{ selectedItems.length }} selected devices? This action
            cannot be undone.
          </p>
          <p v-else>Are you sure you want to delete this device? This action cannot be undone.</p>
        </DialogDescription>
      </DialogHeader>
